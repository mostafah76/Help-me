...
class MapViewController: UIViewController,GMSMapViewDelegate,CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        // draw markers
        var doc1 = Doctor(name: "عبدالسلام", spec: "قلب", long: "\((location?.coordinate.longitude)! - 0.003)", lat: "\((location?.coordinate.latitude)! - 0.00002)")
        ...
        var doc3 = Doctor(name: "عبد الرحمن احمد", spec: "باطنة", long: "\((location?.coordinate.longitude)! + 0.002)", lat: "\((location?.coordinate.latitude)!)")

        var doc4 = Doctor(name: "احمد عبد الحكيم", spec: "نساء وتوليد", long: "\((location?.coordinate.longitude)! + 0.0008)", lat: "\((location?.coordinate.latitude)! + 0.0008)")
